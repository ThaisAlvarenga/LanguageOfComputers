...
Anything that takes more than two lines can be a function

If you are using more than two functions for a speciic purpose


Stack: the method that keeps track of all the functions that are being called
in the program. Thia is last in first out

Fruitful functions return something
Fruitless functions don't return anything
'''
