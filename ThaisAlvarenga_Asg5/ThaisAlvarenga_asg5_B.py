...
DESCRIPTION: Hangman game with word list from web
DATE: 4/03/2023
...
def getWordsFromWeb():
    # variable to save url path
    url = 'https://cs.nyu.edu/~odeh/resources/python/animals.txt'
    # make request to get file from web
    response = requests.get(url)
    # make a list out of the words
    words = response.text.split()

    # return a word list
    return words
# end of getWordsFromWeb()
